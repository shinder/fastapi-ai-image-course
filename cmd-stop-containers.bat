@echo off
rem cmd-stop-containers.bat — 一鍵移除 cmd-start.bat 啟動的三個依賴服務容器
...
rem     pg-data / mongo-data 一律保留，資料仍在；下次 cmd-start.bat 會重新 docker run 並接回。
rem
