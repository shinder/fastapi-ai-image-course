...
| 檔案 | 主題 | 對應後端端點 | 教材 |
| --- | --- | --- | --- |
| `try_10_requests_get.py` | 基本 GET | `GET /api/v1/images/{id}` | 7.2 |
| `try_11_requests_post.py` | 基本 POST（送 JSON） | `POST /api/v1/images` | 7.2 |
| `try_12_requests_exceptions.py` | 例外處理 | `GET /api/v1/images/{id}` | 7.2 |
| `try_13_requests_query.py` | Query / Headers / Cookies | `GET /api/v1/images` | 7.3 |
| `try_14_requests_upload.py` | 上傳檔案（multipart） | `POST /api/v1/images/upload` | 7.3 |
| `try_15_requests_session.py` | Session 連線重用 | `GET /users/me`、`/api/v1/images` | 7.3 |
| `try_16_requests_retry.py` | 自動重試機制 | `GET /api/v1/images` | 7.3 |
| `try_17_requests_auth.py` | 三種認證機制的帶法 | （示意 URL，不實連） | 附錄 C |
| `try_18_client_app.py` | 綜合：模擬第三方串接 | `/api/v1/images/upload`、`/api/v1/images` | 7.4 綜合 |
...
| 檔案 | 主題 | 對應同步版 | 教材 |
| --- | --- | --- | --- |
| `try_20_httpx_get.py` | 基本 GET | `try_10` | 附錄 C |
| `try_21_httpx_post.py` | 基本 POST | `try_11` | 附錄 C |
| `try_22_httpx_exceptions.py` | 例外處理 | `try_12` | 附錄 C |
| `try_23_httpx_query.py` | Query / Headers / Cookies | `try_13` | 附錄 C |
| `try_24_httpx_upload.py` | 上傳檔案 | `try_14` | 附錄 C |
| `try_25_httpx_session.py` | AsyncClient 重用 | `try_15` | 附錄 C |
| `try_26_httpx_retry.py` | 重試機制（傳輸層） | `try_16` | 附錄 C |
| `try_27_httpx_auth.py` | 認證機制 | `try_17` | 附錄 C |
...
- `try_18` 只用到上傳與查詢端點，不需要任何 AI 相關依賴。
